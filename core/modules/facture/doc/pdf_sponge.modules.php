...
// Add the customer's phone number to the address block
if (!empty($object->thirdparty->phone)) {
    $carac_client .= "\n" . $outputlangs->transnoentities("Phone") . " : " . $object->thirdparty->phone;
}

// Add the customer's mobile number to the address block
if (!empty($object->thirdparty->phone_mobile)) {  // Assuming fax field is used for mobile number
    $carac_client .= "\n" . $outputlangs->transnoentities("Mobile") . " : " . $object->thirdparty->fax;
}
