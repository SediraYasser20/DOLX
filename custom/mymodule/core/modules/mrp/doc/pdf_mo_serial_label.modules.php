...
class pdf_mo_serial_label extends ModelePDFMo
{
    ...
    public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
    {
        ...
        // Fetch serial numbers of produced products
        ...
        while ($row = $this->db->fetch_object($resql)) {
            ...
            $printH = $pageH - 2 * $marginV;

            // Vertical center inside printable area
            $posY = $marginV + max(0, ($printH - $textH) / 2);

            // Position cursor and print centered text
